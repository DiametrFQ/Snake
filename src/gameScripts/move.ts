...
const move = (ctx: CanvasRenderingContext2D, foodColor :string, snakeColor: string, globalSettings: CglobalSettings, snakeMove: string, score: number, bestScore: number) => {
